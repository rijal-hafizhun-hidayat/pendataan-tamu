...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE pertanyaan SET pertanyaan = '$pertanyaan' WHERE id_pertanyaan = '$id_pertanyaan'";
    $query = mysqli_query($konek, $sql);
    if ($query) { ?>
        <script>
...
<head>
    ...
    <title>E-Tamu | Edit Data Pertanyaan</title>
    <style>
        .margin {
            margin-left: 70px;
            margin-top: 20px;
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="data_pertanyaan.php" class="nav-link active">
                        ...
                        <div class="col-sm-6">
                            <form action="" method="post">
                                <div class="form-group">
                                    <input type="text" value="<?php echo $result['pertanyaan']; ?>" placeholder="pertanyaan" name="pertanyaan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                </div>
