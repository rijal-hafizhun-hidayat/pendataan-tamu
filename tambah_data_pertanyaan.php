...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO pertanyaan (pertanyaan) VALUES ('$pertanyaan')";
                        ...
                        <div class="col-sm-6">
                            <form action="" method="post">
                                <div class="form-group">
                                    <input type="text" placeholder="Tambah Data Pertanyaan" name="pertanyaan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                </div>
