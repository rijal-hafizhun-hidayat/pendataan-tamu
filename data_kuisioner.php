        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="data_kuisioner.php" class="nav-link active">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Data Kuisioner</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                ...
                                <div class="card-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            require 'konek.php';
                                            $no = 1;
                                            $select = "SELECT * FROM kuisioner INNER JOIN pertanyaan ON kuisioner.id_pertanyaan = pertanyaan.id_pertanyaan INNER JOIN tamu ON kuisioner.id_tamu = tamu.id_tamu";
