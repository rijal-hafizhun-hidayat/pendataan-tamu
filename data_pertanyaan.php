                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="tambah_data_pertanyaan.php"><button class="btn btn-success"><i class="fas fa-plus"></i> Tambah Data Pertanyaan</button></a>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_array($sql)) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="edit_data_pertanyaan.php?id_pertanyaan=<?= $row['id_pertanyaan']; ?>"><button type="button" name="kirim" class="btn btn-block btn-warning btn-sm mt-2"><i class="fas fa-user-edit"></i></button></a>
                                                    </td>
                                                </tr>
                                            <?php $no++;
                                            } ?>
